...
- (void)viewWillAppear:(BOOL)animated
{
	...
	NSLog(@"networkGallery.currentIndex==%d",_currentIndex);
    _isActive = YES;
...
#pragma GCC diagnostic warning "-Wdeprecated-declarations"
    ...
    self.navigationController.navigationBar.tintColor = [UIColor colorWithRed:229.0/255.0 green:95.0/255.0 blue:76.0/255.0 alpha:1];
